using PaymentIntegration.Web.Helpers;
using PaymentIntegration.Web.Models;
using System;
...
namespace PaymentIntegration.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult ThreeDGate()
        {
            ...
            string successUrl = "http://localhost:2428/Home/Success";//Başarılı Url
            string unsuccessUrl = "http://localhost:2428/Home/UnSuccess";//Hata Url
